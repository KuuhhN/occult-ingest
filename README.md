...
<p align="center">
  <strong>贤者之石 — 神秘学知识库 · 自带 15 本书的笔记 + 可扩展工具链</strong>
</p>
...
| | 工具链 | 知识库 |
|---|---|---|
| 内容 | `ocr_extract.py` + `format_ocr.py` | ~70 篇已审核笔记 |
...
> 📸 *按 Ctrl+E 切换到阅读模式；按 Ctrl+G 打开图谱视图，看看知识之间的连线。*
...
│   └── examples/          ← 单篇示例
├── knowledge-base/        ← 知识库（Obsidian Vault）
│   ├── 00-MOC/            ← 总览索引
│   ├── 01-知识库/         ← 按体系分类的条目
│   ├── 03-导读/           ← 快速导读
│   ├── 05-摘要/           ← 分层摘要目录
...
> ⚠️ `02-文献库/` 中的 PDF 和 OCR 原文不包含在仓库中。这是你本地私有的文件，不会上传。
